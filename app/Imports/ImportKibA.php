        ...
        try {
            ...
            foreach ($rows as $row) {
                ...
                $document = [
                    ...
                    "created_at" => $this->parseTanggalExcel($mapped['dokumen_tanggal'] ?? null),
                    "kapitalisasi" => 0,
                    "ppn_harga" => 0,
                    "nama_hibah" => null,
                    "no_bast" => null,
                ...
                $asset = [
                    ...
                    "tanggal_buku" => $this->parseTanggalExcel($mapped['dokumen_tanggal'] ?? null),
                    "tanggal_pembelian" => $this->parseTanggalExcel($mapped['dokumen_tanggal'] ?? null),
                    "kode_lokasi" => null,
